...
public class SettingsActivity extends BaseActivity implements View.OnClickListener {
            ...
            switch (view.getId()) {
                ...
                case R.id.tv_save:
                    ...
                    if (childName.isEmpty()) {
                        ...
                        service.updateProfile(profile, PreferenceUtil.getAccessToken(this)).enqueue(new Callback<in.ninos.models.Response>() {
                            @Override
                            ...
                            @Override
                            public void onFailure(@NonNull Call<in.ninos.models.Response> call, @NonNull Throwable t) {
                                showToast(R.string.error_update_profile);
                            }
                        });
                    }
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(ProfileActivity.IS_PROFILE_UPDATED, isProfileUpdated);
