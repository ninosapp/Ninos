...
public class ImagePickFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            imagePickAdapter = new ImagePickAdapter(mBaseActivity);
